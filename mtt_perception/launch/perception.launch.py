...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'cloud_merger_publish_reliable_raw',
            default_value='false',
            description='Publish /merged_points_reliable: raw fused cloud with reliable QoS for ICP mappers',
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            'cloud_merger_hesai_stride',
            default_value='1',
            description='Keep one out of N Hesai points before merging',
        ),
        DeclareLaunchArgument(
            'cloud_merger_rsairy_stride',
            default_value='1',
            description='Keep one out of N RS-Airy points before merging',
        ),
        DeclareLaunchArgument(
            'cloud_merger_rsairy_inject_every_n',
            default_value='1',
            description='Inject RS-Airy into one out of N Hesai-anchored merged frames',
        ),
        DeclareLaunchArgument(
            'cloud_merger_enable_self_bbox_filter',
            default_value='true',
            description='Apply cloud_merger chassis/cage/trailer bbox filters to /merged_points_filtered',
        ),
        DeclareLaunchArgument(
