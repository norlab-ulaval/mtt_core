...
private:
  ...
  // The operator can always exit AUTO by moving the stick or pressing the
  // explicit MANUAL/STOP buttons. Deadman alone is the AUTO presence gate and
  // must not change the selected mode.
