...
def generate_launch_description():
        ...
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    ...
                    os.path.join(mtt_bringup_launch_dir, 'mtt_navigation.launch.py')
                ),
                launch_arguments={
                    'namespace': namespace,
                    'use_sim_time': use_sim_time,
    ...
    mtt_controller = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(mtt_bringup_launch_dir, 'mtt_controller.launch.py')),
        launch_arguments={
            'namespace': namespace,
